...
class DashboardController extends Controller
{
    ...
    public function index()
    {
        ...
        return view('admin.dashboard',compact('activation_notify','pending','processing','completed','products','blogs','referrals','browsers'));
    }
    ...
    {
        $bkuplink = "";
        if (file_exists(public_path().'/backup.txt')){
