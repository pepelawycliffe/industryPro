                                ...
                                Loader :
                                      ...
                                      <div class="action-list">
                                          <select class="process select droplinks {{ $gs->is_loader == 1 ? 'drop-success' : 'drop-danger' }}">
                                            <option data-val="1" value="{{route('admin-gs-isloader',1)}}" {{ $gs->is_loader == 1 ? 'selected' : '' }}>Activated</option>
                                            <option data-val="0" value="{{route('admin-gs-isloader',0)}}" {{ $gs->is_loader == 0 ? 'selected' : '' }}>Deactivated</option>
                                          </select>
                                        </div>
                          </div>
