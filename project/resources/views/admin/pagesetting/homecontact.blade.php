...
@section('content')
            ...
            <div class="content-area">
              <div class="mr-breadcrumb">
                <div class="row">
                  <div class="col-lg-12">
                      <h4 class="heading">Contact Section </h4>
                      <ul class="links">
                        <li>
                        ...
                        <li>
                          <a href="{{ route('admin-ps-homecontact') }}">Contact Section </a>
                        </li>
                      </ul>
                  </div>
                </div>
                    ...
                    <div class="product-description">
                      ...
                      <form id="geniusform" action="{{ route('admin-ps-update') }}" method="POST" enctype="multipart/form-data">
                        ...
                        <div class="row">
                          ...
                          <div class="col-lg-7">
                          <textarea class="input-field" name="c_title" placeholder="Title" required="" rows="5">{{$data->c_title}} </textarea>
