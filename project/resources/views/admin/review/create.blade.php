                    ...
                    <div class="product-description">
                      ...
                      <form id="geniusformdata" action="{{route('admin-review-create')}}" method="POST" enctype="multipart/form-data">
                        ...
                        <div class="row">
                          ...
                          <div class="col-lg-7">
                            <input type="text" class="input-field" name="subtitle" placeholder="Sub Title" required="" value="">
                          </div>
                        </div>
                        ...
                        <div class="row">
                          ...
                          <div class="col-lg-7">
                              <textarea  class="input-field" rows="5" name="details" placeholder="Details"></textarea> 
                          </div>
                        </div>
                        ...
                        <div class="row">
                          ...
                          <div class="col-lg-7">
                            <button class="addProductSubmit-btn" type="submit">Create Review</button>
                          </div>
                        </div>
                      </form>
                      </div>
