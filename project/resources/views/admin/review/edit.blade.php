                    ...
                    <div class="product-description">
                      ...
                      <form id="geniusformdata" action="{{route('admin-review-update',$data->id)}}" method="POST" enctype="multipart/form-data">
                        ...
                        <div class="row">
                          ...
                          <div class="col-lg-7">
                            <input type="text" class="input-field" name="subtitle" placeholder="Sub Title" value="{{$data->subtitle}}" required="">
                          </div>
                        </div>
                        ...
                        <div class="row">
                          ...
                          <div class="col-lg-7">
                              <textarea class="input-field" name="details" rows="5" placeholder="Details">{{ $data->details }}</textarea> 
                          </div>
                        </div>
