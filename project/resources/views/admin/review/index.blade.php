                        ...
                        <div class="row">
                          ...
                          <div class="col-lg-12">
                            ...
                            <div class="img-upload full-width-img">
                                <div id="image-preview" class="img-preview" style="background: url({{ App\Models\Pagesetting::findOrFail(1)->review_background ? asset('assets/images/'.App\Models\Pagesetting::findOrFail(1)->review_background):asset('assets/images/noimage.png') }});">
                                    <label for="image-upload" class="img-label" id="image-label"><i class="icofont-upload-alt"></i>Upload Image</label>
                                    <input type="file" name="review_background" class="img-upload" id="image-upload">
                                  </div>
