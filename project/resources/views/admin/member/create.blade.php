                    ...
                    <div class="product-description">
                      ...
                      <form id="geniusformdata" action="{{route('admin-member-create')}}" method="POST" enctype="multipart/form-data">
                        ...
                        <div class="row">
                          ...
                          <div class="col-lg-7">
                            <input type="text" class="input-field" name="facebook" placeholder="Facebook URL" value="">
                          </div>
                        </div>
                        ...
                        <div class="row">
                          ...
                          <div class="col-lg-7">
                            <input type="text" class="input-field" name="twitter" placeholder="Twitter URL" value="">
                          </div>
                        </div>
                        ...
                        <div class="row">
                          ...
                          <div class="col-lg-7">
                            <input type="text" class="input-field" name="subtitle" placeholder="Linkdedin URL" value="">
                          </div>
                        </div>
