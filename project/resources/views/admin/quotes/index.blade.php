...
@section('content')  
                    <div class="content-area">
                        <div class="mr-breadcrumb">
                            <div class="row">
                                <div class="col-lg-12">
                                        <h4 class="heading">All Quotes</h4>
                                        <ul class="links">
                                            <li>
                                            ...
                                            <li>
                                                <a href="{{ route('admin-quote-index') }}">All Quotes</a>
                                            </li>
                                        </ul>
                                </div>
                            </div>
...
<div class="modal fade" id="confirm-delete" tabindex="-1" role="dialog" aria-labelledby="modal1" aria-hidden="true">
        <div class="modal-dialog">
          ...
          <div class="modal-header d-block text-center">
            ...
            <!-- Modal body -->
            <div class="modal-body">
                  <p class="text-center">You are about to delete this Quote.</p>
...
{{-- DATA TABLE --}}
    ...
    <script type="text/javascript">
        ...
        var table = $('#geniustable').DataTable({
               ...
               processing: true,
               serverSide: true,
               ajax: '{{ route('admin-quote-datatables','none') }}',
               columns: [
